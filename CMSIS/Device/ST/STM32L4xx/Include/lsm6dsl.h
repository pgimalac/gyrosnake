// from
// https://raw.githubusercontent.com/intel/zephyr/master/drivers/sensor/lsm6dsl/lsm6dsl.h
...
#define LSM6DSL_MASK_SENSOR_SYNC_TIME_FRAME_TPH                                \
...
#define LSM6DSL_MASK_FIFO_CTRL1_FTH                                            \
...
#define LSM6DSL_MASK_FIFO_CTRL2_FTH (BIT(2) | BIT(1) | BIT(0))
#define LSM6DSL_SHIFT_FIFO_CTRL2_FTH 0

#define LSM6DSL_REG_FIFO_CTRL3 0x08
#define LSM6DSL_MASK_FIFO_CTRL3_DEC_FIFO_GYRO (BIT(5) | BIT(4) | BIT(3))
#define LSM6DSL_SHIFT_FIFO_CTRL3_DEC_FIFO_GYRO 3
#define LSM6DSL_MASK_FIFO_CTRL3_DEC_FIFO_XL (BIT(2) | BIT(1) | BIT(0))
...
#define LSM6DSL_MASK_FIFO_CTRL4_DEC_DS4_FIFO (BIT(5) | BIT(4) | BIT(3))
#define LSM6DSL_SHIFT_FIFO_CTRL4_DEC_DS4_FIFO 3
#define LSM6DSL_MASK_FIFO_CTRL4_DEC_DS3_FIFO (BIT(2) | BIT(1) | BIT(0))
#define LSM6DSL_SHIFT_FIFO_CTRL4_DEC_DS3_FIFO 0

#define LSM6DSL_REG_FIFO_CTRL5 0x0A
#define LSM6DSL_MASK_FIFO_CTRL5_ODR_FIFO (BIT(5) | BIT(4) | BIT(3))
#define LSM6DSL_SHIFT_FIFO_CTRL5_ODR_FIFO 3
#define LSM6DSL_MASK_FIFO_CTRL5_FIFO_MODE (BIT(2) | BIT(1) | BIT(0))
...
#define LSM6DSL_MASK_CTRL1_XL_ODR_XL (BIT(7) | BIT(6) | BIT(5) | BIT(4))
...
#define LSM6DSL_MASK_CTRL2_G_ODR_G (BIT(7) | BIT(6) | BIT(5) | BIT(4))
...
#define LSM6DSL_MASK_CTRL5_C_ROUNDING (BIT(7) | BIT(6) BIT(5))
...
#define LSM6DSL_MASK_FIFO_STATUS2_DIFF_FIFO (BIT(2) | BIT(1) | BIT(0))
...
#define LSM6DSL_MASK_TAP_THS_6D_TAP_THS                                        \
    (BIT(4) | BIT(3) | BIT(2) | BIT(1) | BIT(0))
#define LSM6DSL_SHIFT_TAP_THS_6D_TAP_THS 0

#define LSM6DSL_REG_INT_DUR2 0x5A
#define LSM6DSL_MASK_INT_DUR2_DUR (BIT(7) | BIT(6) | BIT(5) | BIT(4))
...
#define LSM6DSL_MASK_WAKE_UP_THS_WK_THS                                        \
...
#define LSM6DSL_MASK_WAKE_UP_DUR_SLEEP_DUR (BIT(3) | BIT(2) | BIT(1) | BIT(0))
...
#define LSM6DSL_MASK_FREE_FALL_THS (BIT(2) | BIT(1) | BIT(0))
